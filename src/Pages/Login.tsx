    ...
    <main className="w-full flex flex-row h-screen bg-black">
      <section className="w-full lg:w-1/2 flex justify-center items-center flex-col px-6 lg:px-16 bg-black">
        <div className="w-full max-w-md">
          <img src="../../img/MJCinema-SinFondo.png" className='w-70 relative right-7 pb-6'/>
          ...
          <div className="w-full">
            ...
            <div className="mb-6 text-right">
              <a href="#" className="text-red-500 text-sm hover:text-red-400 transition-colors">
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 bg-zinc-900 hover:bg-zinc-800 text-white border border-zinc-800 py-3 px-4 rounded-lg transition-colors"
                >
      ...
      <div className="hidden lg:block relative w-1/2 h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center h-full px-12 xl:px-16 text-white">
          <div className="max-w-xl">
            <h1 className="text-5xl xl:text-6xl font-bold leading-tight mb-6">
              Miles de películas{' '}
              <span className="text-red-500">te esperan</span>
            </h1>
